...
window.addEventListener("load", () => {
    ...
    first.outerHTML = '<span class="badge bg-primary rounded-pill ms-auto">v1.0.7</span>';
});
...
$(function() {
    ...
    $('.choose-skin li').on('click', function() {
        var $body = $('#layout-a, #layout-b, #layout-c, #layout-d, #layout-d-sub-header, #layout-e, #layout-f, #layout-g, #layout-h,  #layout-i, #layout-j, #layout-k, #layout-l, #layout-m, #layout-p, #layout-n, #layout-q',);
        var $this = $(this);
